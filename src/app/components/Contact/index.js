      ...
      <div className="w-[90%] lg:w-[70%] mx-auto  grid grid-cols-1 md:grid-cols-2">
        ...
        >
          <Image
            ...
            className="w-[350px] h-[350px] dark:hidden"
            style={{ perspective: '300px' }}
            alt=""
          />

          <svg
            className="w-[300px] h-[300px] fill-white hidden dark:block"
        ...
        <div>
          <div className="w-[90%] mx-auto">
            <h2 className="w-[80%] mx-auto pl-[5px] text-[30px] font-semibold text-[#333] dark:text-white font-sans">
              Get in touch
            </h2>
            <form className="mt-8">
              <div
                ref={refs[0]}
                className="w-[80%] mx-auto  outline-none bg-[#E6E6E6] dark:bg-white/10 dark:border dark:border-white/20 rounded-3xl flex justify-center items-center py-[8px]"
              >
                <div className="flex gap-x-[2%] w-[90%] justify-center items-center ">
                  ...
                  <input
                    ...
                    type="text"
                    placeholder="Name"
                    className="w-[91%] h-[30px] bg-[#E6E6E6] dark:bg-transparent dark:text-white dark:placeholder:text-gray-400 font-bold border-none outline-none"
                  />
                </div>
              </div>
              <div
                ref={refs[1]}
                className="w-[80%] mt-4 mx-auto  outline-none bg-[#E6E6E6] dark:bg-white/10 dark:border dark:border-white/20 rounded-3xl flex justify-center items-center py-[8px]"
              >
                <div className="flex gap-x-[2%] w-[90%] justify-center items-center ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div
                ref={refs[2]}
                className="w-[80%] mt-4 mx-auto  outline-none bg-[#E6E6E6] dark:bg-white/10 dark:border dark:border-white/20 rounded-xl flex justify-center items-center py-[8px]"
              >
                <div className="flex w-full justify-center items-center ">
                  <textarea
                    ...
                    type="text"
                    placeholder="Message"
                    className="w-[90%] h-[160px] bg-[#E6E6E6] dark:bg-transparent dark:text-white dark:placeholder:text-gray-400 pl-[5px] font-bold border-none outline-none"
                  />
                </div>
              </div>
              {loading ? (
                <div className="w-[80%] mx-auto mt-4 bg-[#846ADD]  bg-gradient-to-top bg-top bg-[length:100%_200%] hover:bg-bottom transition-all duration-1000 ease-out  outline-none rounded-3xl flex justify-center items-center">
                  <button className="w-full h-[40px]  font-bold text-center rounded-3xl text-[white]">
                ...
                <div
                  ...
                  className="w-[80%] mx-auto mt-4 bg-[#846ADD]  bg-gradient-to-top bg-top bg-[length:100%_200%] hover:bg-bottom transition-all duration-1000 ease-out  outline-none rounded-3xl flex justify-center items-center"
                >
                  <button className="w-full h-[40px]  font-bold text-center rounded-3xl text-[white]">
                    Send
                  </button>
