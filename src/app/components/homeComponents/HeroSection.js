...
const HeroSection = () => {
  ...
  return (
    <div className="py-20  bg-transparent flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        {/* CTA Button */}
        <button
          className="group relative px-8 py-4 bg-purple-400 text-black font-semibold rounded-full 
                           transition-all duration-300 hover:bg-purple-300 hover:scale-105 
                           hover:shadow-lg hover:shadow-purple-400/25"
        >
          <span className="relative z-10">View My Projects</span>
          <div
            className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-500 to-purple-400 
